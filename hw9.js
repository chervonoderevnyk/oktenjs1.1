...
//     monthDuration.style.border = '3px solid blue';
//     monthDuration.style.margin = '12px';
//     monthDuration.style.fontSize = '22px';
//     mainDiv.append(monthDuration);
//
//     let hourDuration = document.createElement('div');
//     hourDuration.innerText = `${item.hourDuration}`;
//     hourDuration.style.border = '3px solid blue';
//     hourDuration.style.margin = '12px';
//     hourDuration.style.fontSize = '22px';
...
//     input.oninput;
//     if (input.value < 18) {
//         alert('Pidrosty, shnurok!');
//     }
//     else if (input.value >= 18) {
//         alert('Welcom to Ukraine');
//     }
//}
